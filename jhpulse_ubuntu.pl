...
MAIN: {
	...
	# Download, unpack, and remove archive.
	`cd ~/ && wget http://engineering.jhu.edu/jhpulse/jhpulse.tar.gz`;
	`tar -xvzf ~/jhpulse.tar.gz`;
	`rm -rf ~/jhpulse.tar.gz`;
